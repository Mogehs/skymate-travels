...
const Destinations = () => {
  ...
  return (
    <section className='py-16 px-4 md:px-6 lg:px-20 font-dm mb-20 bg-gradient-to-br from-gray-50 to-orange-50'>
      <div className='text-center mb-10'>
        <h2 className='text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 mb-4'>
          Destinations Of <span className='text-[#EB662B]'>The Month</span>
        </h2>
        <p className='text-base md:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed'>
          Discover the most captivating destinations and hidden gems around the
          world
        </p>
      </div>
        ...
        {Object.keys(data).map((city) => (
          <button
            ...
            className={`px-6 py-3 border-2 rounded-full text-sm font-medium transition-all duration-300 cursor-pointer ${
              activeTab === city
                ? 'bg-gradient-to-r from-[#EB662B] to-[#DD5471] text-white border-transparent shadow-lg'
                : 'text-gray-700 border-gray-300 hover:border-[#EB662B] hover:bg-white hover:shadow-md'
            }`}
          >
            {city}
          </button>
          ...
          >
            ...
            <div className='absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 flex flex-col justify-end p-4'>
              ...
              <div className='absolute top-3 left-3'>
                <span className='px-3 py-1 bg-gradient-to-r from-[#EB662B] to-[#DD5471] text-white text-xs font-medium rounded-full shadow-lg'>
                  {dest.category}
                </span>
              </div>
      ...
      {filteredDestinations.length === 0 && (
        <div className='text-center py-12'>
          ...
          <button
            ...
            className='mt-4 px-6 py-2 bg-gradient-to-r from-[#EB662B] to-[#DD5471] text-white rounded-lg hover:from-[#d05a26] hover:to-[#c04a5f] transition-all duration-300'
          >
            Show All
          </button>
        </div>
